...
Our team proposed a [solution](https://www.youtube.com/watch?v=GP2CzDD_apY) to replace animal based products in recipes such as eggs for foam and emulsion, taking into account available tools, budget and other production constraints using precision fermentation thanks to a multi-agent system using the google ADK framework.
